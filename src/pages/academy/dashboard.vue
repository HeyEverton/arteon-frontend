      ...
      >
        <div class="pe-3">
          <h5 class="text-h5 mb-2">
            Bem-vindo de volta,<span class="text-h4"> Estudante 👋🏻 </span>
          </h5>
          ...
          >
            Seu progresso essa semana está Ótimo. Vamos manter o ritmo e melhorar seus fundamentos!
          </div>

          <div class="d-flex justify-space-between flex-wrap gap-4 flex-column flex-md-row mt-4">
            <div
              v-for="{ title, value, icon, color } in [
                { title: 'Horas Estudadas', value: '34h', icon: customLaptop, color: 'primary' },
                { title: 'Resultados', value: '82%', icon: customLightbulb, color: 'info' },
                { title: 'Aulas Concluídas', value: '14', icon: customCheck, color: 'warning' },
              ]"
              :key="title"
            >
